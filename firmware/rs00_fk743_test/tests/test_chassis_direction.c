...
int main(void)
{
    ...
    check(45.0f, 45.0f, 1);
    check(90.0f, 0.0f, 1);
    check(135.0f, 135.0f, -1);
    check(180.0f, 90.0f, -1);
    check(181.0f, 89.0f, -1);
    check(225.0f, 45.0f, -1);
    check(270.0f, 180.0f, 1);
    check(315.0f, 135.0f, 1);
    check(359.0f, 91.0f, 1);
    check(360.0f, 90.0f, 1);
    check(-90.0f, 180.0f, 1);
    check(720.0f, 90.0f, 1);
    assert(ChassisDirection_Solve(90.0f, 0.0f, &solution));
