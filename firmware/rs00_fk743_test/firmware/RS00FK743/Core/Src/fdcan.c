...
void MX_FDCAN2_Init(void)
{
  ...
  /* FDCAN1 occupies message RAM words 0..98. */
  hfdcan2.Init.MessageRAMOffset = 99;
...
void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  */
    ...
    /* FDCAN1/FDCAN2 share the same peripheral clock. */
