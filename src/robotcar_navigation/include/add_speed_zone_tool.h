#ifndef ROBOTCAR_NAVIGATION__ADD_SPEED_ZONE_TOOL_H_
#define ROBOTCAR_NAVIGATION__ADD_SPEED_ZONE_TOOL_H_
...
#include "robotcar_navigation/msg/speed_zone.hpp"
...
class AddSpeedZoneTool : public rviz_common::Tool
{
  Q_OBJECT

public:
  AddSpeedZoneTool();
  ~AddSpeedZoneTool() override = default;
...
private:
  ...
  rclcpp::Publisher<msg::SpeedZone>::SharedPtr publisher_;
...
#endif  // ROBOTCAR_NAVIGATION__ADD_SPEED_ZONE_TOOL_H_
